...
function StationBadge({ children }: { children: React.ReactNode }) {
  return (
    <span className="relative inline-flex items-center justify-center px-5 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-sky-400 sm:px-10 sm:py-3 sm:text-xs sm:tracking-[0.4em]">
      <span className="absolute inset-0 border border-sky-400/80" aria-hidden />
      <span
        className="absolute -top-1 -left-1 h-3 w-3 bg-sky-400"
        aria-hidden
      />
      <span
        className="absolute -top-1 -right-1 h-3 w-3 bg-sky-400"
        aria-hidden
      />
      <span
        className="absolute -bottom-1 -left-1 h-3 w-3 bg-sky-400"
        aria-hidden
      />
      <span
        className="absolute -bottom-1 -right-1 h-3 w-3 bg-sky-400"
        aria-hidden
      />
      <span className="relative tracking-[0.22em] sm:tracking-[0.4em]">
        {children}
      </span>
    </span>
  );
  ...
  return (
    <div className="relative flex justify-center">
      ...
      >
        ...
        {hasImage ? (
          <>
            <div className="relative overflow-hidden rounded-sm aspect-square bg-neutral-200">
        ...
        <div
          className="absolute -bottom-8 left-1/2 h-2 w-12 -translate-x-1/2 bg-yellow-300/70 blur-[2px]"
          aria-hidden
        />
      </div>
    </div>
      ...
      <main className="relative flex-1 overflow-hidden px-4 py-8 pt-20 sm:px-10 sm:py-10 sm:pt-24 lg:px-16">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <h1
              className={`mt-6 flex items-center justify-center gap-1 text-3xl font-extrabold uppercase sm:mt-8 sm:gap-2 sm:text-5xl lg:text-6xl ${DINEng.className}`}
            >
              <span className="tracking-[0.03em] text-white">Photo</span>
              <span className="tracking-[0.03em] text-sky-400">Gallery</span>
              <span className="text-3xl text-sky-400 sm:text-5xl lg:text-6xl"></span>
            </h1>
            <p
              className="mt-3 px-2 text-xs tracking-[0.14em] text-gray-400 sm:text-base sm:tracking-widest"
          ...
          <section className="mt-8 sm:mt-12">
            <div className="relative border border-neutral-800/70 bg-[#121212] px-4 py-6 shadow-[0_50px_120px_rgba(0,0,0,0.65)] sm:px-12 sm:py-12">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:mt-12 sm:flex-row sm:items-center sm:justify-center sm:gap-6">
            <button className="flex w-full items-center justify-center gap-3 border border-neutral-700 bg-neutral-900/80 px-6 py-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-gray-100 shadow-[0_18px_40px_rgba(0,0,0,0.45)] transition hover:border-neutral-500 hover:bg-neutral-900 sm:w-auto sm:gap-4 sm:px-10 sm:py-5 sm:text-xs sm:tracking-[0.32em]">
              <Image
            ...
            <button className="flex w-full items-center justify-center gap-3 bg-red-600 px-6 py-4 text-[10px] font-semibold uppercase tracking-[0.18em] text-white shadow-[0_20px_45px_rgba(220,38,38,0.45)] transition hover:bg-red-500 sm:w-auto sm:gap-4 sm:px-10 sm:py-5 sm:text-xs sm:tracking-[0.32em]">
              <Image
